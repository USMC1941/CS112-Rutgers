...
/**
 * Binary Search Tree (BST) Duplicates not allowed Comparable requires T objects to implement
 * compareTo
 *
 * <p>Comparable is an interface that imposes a total ordering on the objects of the class that
 * implements it. An interface is not a class, it defines a set of variables and methods.
 */
public class BST<T extends Comparable<T>> {
    ...
    public void delete(T key) {
        ...
        // will hold x's inorder predecessor
        BSTNode<T> y;
    ...
    /**
     * Static because it does not use the BST object's root. Every recursive call gets its own root.
     *
     * <p>Also, need to define T separately for the static method since it does NOT fall under the
     * scope of the object
     */
    ...
    /**
     * Treesort algorithm to sort an array. 1. Insert every element from the array into a BST 2. Add
     * back elements to array as we traverse the BST inorder
     */
    ...
    public static void main(String[] args) {
        ArrayList<Integer> array = new ArrayList<>(Arrays.asList(67, 35, 90, 56, 70, 14, 40));
        treeSort(array);
