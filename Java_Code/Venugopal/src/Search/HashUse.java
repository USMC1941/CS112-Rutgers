...
class Point {
    ...
    */
    ...
    /**
     * implement a hashCode method, that overrides the Object class' hashCode method - the trick is
     * to use the String class' hashCode on a string representation of this object
     */
    public int hashCode() {
        return ("" + x + y).hashCode();
    }
...
public class HashUse {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, Person> people = new HashMap<>(500, 2.5f);
        ...
        HashMap<Point, Point> points = new HashMap<>(100, 0.75f);
        Point[] pointset = {new Point(2, 3), new Point(2, 5), new Point(4, 5), new Point(1, 6)};
